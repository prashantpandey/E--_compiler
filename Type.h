...
public:
    ...
    static bool isString(TypeTag t) {
        return (t==STRING);
    }
    static bool isNumeric(TypeTag t) {
        return ((t >= BYTE) && (t <= DOUBLE));
    }
    static bool isBool(TypeTag t) {
        return (t == BOOL);
    }
    static bool isInt(TypeTag t) {
        return ((t == INT) || (t == UINT));
    }
    ...
    static bool isData(TypeTag t) {
        return ((t >= VOID) && (t <= CLASS));
    }
    static bool isValid(TypeTag t) {
        return ((t >= VOID) && (t <= FUNCTION));
    }
    static bool isScalar(TypeTag t) {
        return ((t >= BOOL) && (t <= DOUBLE));
    }
